        ...
        <div class="container py-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form action="{{ route('admin.tests.update', $tests->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-4">
                                    <label for="inputText" class="col-sm-4 col-form-label">Test Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="tests" value="{{ $tests->tests }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="description" value="{{ $tests->description}}">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="inputText" class="col-sm-4 col-form-label">Price</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="charges" value="{{ $tests->charges }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="discount" value="{{ $tests->discount }}">
                                    </div>
                                </div>
                        </div>
