    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Test Name</span><i
        ...
        <li class="nav-item">
            <a href="{{ route('admin.order.index') }}" class="nav-link collapsed">
                <i class="bi bi-journal-text"></i><span>Order</span>
            </a>
        </li>
        {{-- <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('admin.cart.index') }}">
                        <i class="bi bi-circle"></i><span>View All Cart</span>
                    </a>
                </li> --}}
                {{-- <li>
